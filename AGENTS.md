...
- Historical baseline (old branch/work): `1.21.7`.
- Current repository snapshot target: `1.21.11`.
...
- Current default in this repo: `1.21.11`.
- Example sequence:
  - `mcdev_mc_set_version(version="1.21.11")`
